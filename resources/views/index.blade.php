...
<html lang="en">
  ...
  <head>
    ...
    <title>Welcome To Hanes Landing Page</title>
<!--
            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                        <h1>Hanes Landing Page <strong>The Best !</strong></h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-12 col-sm-12">
                    <p class="copyright">Copyright &copy; 2022 Hanes Landing Page
                
                . Design: <a rel="nofollow" href="#">Synt4x16</a></p>
                </div>
